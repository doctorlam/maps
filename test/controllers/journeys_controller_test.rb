...
class JourneysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create journey" do
    assert_difference('Journey.count') do
      post journeys_url, params: { journey: { description: @journey.description, name: @journey.name, rating: @journey.rating } }
    end
  ...
  test "should update journey" do
    patch journey_url(@journey), params: { journey: { description: @journey.description, name: @journey.name, rating: @journey.rating } }
